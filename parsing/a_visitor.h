...
public:
    ...
    virtual Value visit_do_while_stmt(DoWhileStmt *stmt) = 0;
    virtual Value visit_break_stmt(BreakStmt *stmt) = 0;
    virtual Value visit_continue_stmt(ContinueStmt *stmt) = 0;
